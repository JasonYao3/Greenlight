...
import (
	...
	"github.com/jasonyao3/greenlight/internal/data"
	"github.com/jasonyao3/greenlight/internal/jsonlog"
	"github.com/jasonyao3/greenlight/internal/mailer"
	_ "github.com/lib/pq"
)
...
func main() {
	...
	// replace <smtp-username>, <smtp-password> and <smtp-email> with your Mailtrap credentials.
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <smtp-email>", "SMTP sender")
	...
	expvar.Publish("gorountines", expvar.Func(func() interface{} {
